...
<body class="min-h-screen bg-white dark:bg-zinc-800">
    ...
    <div class=" fixed bottom-4 right-5 z-50 w-auto h-auto">
        <div
        ...
        >
            ...
            <div
                ...
                class="relative w-auto z-50 overflow-hidden rounded-sm border border-green-500 bg-white text-neutral-600 dark:bg-neutral-950 dark:text-neutral-300" role="alert">
                <div class="flex w-full items-center gap-2 bg-green-500/10 p-4">
                    ...
                    <div class="ml-2">
                        <h3 class="text-sm font-semibold text-green-500">عملیات موفقیت آمیز!</h3>
            ...
            <div
                x-show="type == 'failed' || type == 'error'"
                x-transition:enter.duration.500ms
                x-transition:leave.duration.400ms
                class="relative w-auto z-50 overflow-hidden rounded-sm border border-red-500 bg-white text-neutral-600 dark:bg-neutral-950 dark:text-neutral-300" role="alert">
                <div class="flex w-full items-center gap-2 bg-red-500/10 p-4">
                    ...
                    <div class="ml-2">
                        <h3 class="text-sm font-semibold text-red-500">عملیات با مشکل مواجه شد!</h3>
                        <p class="text-xs font-medium sm:text-sm" x-text="message"></p>
                    </div>
                    <button class="ml-auto" aria-label="dismiss alert">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" stroke="currentColor" fill="none" stroke-width="2.5" class="size-4 shrink-0">
