    ...
    <div class="mt-7 bg-white border border-gray-200 rounded-xl shadow-2xs dark:bg-neutral-900 dark:border-neutral-700">
        <div class="p-4 sm:p-7">
            <div class="text-center">
                <h1 class="block text-2xl font-bold text-gray-800 dark:text-white">ویرایش حساب</h1>
            </div>

            <div class="mt-5">
                <!-- Form -->
                <form wire:submit="update({{$account}})">
                    <div class="grid gap-y-4">
                        <!-- Form Group -->
                        <div class="grid grid-cols-4 gap-20 items-end">
                            <div>
                            ...
                            <div>
                                <button type="submit" class="py-3 px-4 items-center text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-hidden focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none">ثبت ویرایش</button>
                            </div>
